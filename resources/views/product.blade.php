                            ...
                            <div class="latest-product__text">
                                ...
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <a href="{{route('product.show')}}" class="latest-product__item">
                            ...
                            <div class="product__discount__slider owl-carousel">
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5><a href="{{route('product.show')}}">Raisin’n’nuts</a></h5>
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5><a href="{{route('product.show')}}">Vegetables’package</a></h5>
                                            <div class="product__item__price">$30.00 <span>$36.00</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Dried Fruit</span>
                                            <h5><a href="{{route('product.show')}}">Mixed Fruitss</a></h5>
                                            <div class="product__item__price">$30.00 <span>$36.00</span></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="{{route('product.show')}}">Crab Pool Security</a></h6>
                                    <h5>$30.00</h5>
                                </div>
                            </div>
                        </div>
